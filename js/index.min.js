...
jQuery(function() {
	...
	if (api.siteToken == null || api.siteToken == "null") {
		location.href = 'login.html';
	}
	else{
		api.ajaxPost('/getUserInfo',).then(res => {			
			if (!res.data.admin){
				location.href = 'login.html';
			}
			else{
				//$('#admin_avatar').attr('src',res.data.avatar);
				$('#admin_name').text(res.data.name);
			}
		});
	}
	...
	$('#logout').click(function(){
		localStorage.setItem("siteToken", null);
		location.href = 'login.html';
	});
